        ...
        <section class="clean-block features">
            <div class="container">
                <div class="block-heading mb-2 pt-3">
                    <h2 class="text-info mb-0 main-color">Tabla de posiciones</h2>
                    <p class="main-color">Consulta los puntos y posiciones de los equipos</p>
                </div>
                <div class="row justify-content-center">
                    <div class="col">
                        <div class="table-responsive">
                            <table class="table main-color rounded-5">
                                ...
                                <div class="carousel-item active">
                                    <div class="row" style="max-height: 40rem;">
                                        <div class="col col-12 col-sm-5 ps-sm-4" style="max-height: inherit;">
                                            <div class="row">
                                                <div class="col">
                                                    <h1 class="text-center submain-color m-0">Harry Kane</h1>
                                                </div>
                                            </div>
