                                ...
                                <tbody class="text-center table-striped">
                                    <tr>
                                        ...
                                        <td class="align-middle submain-bg-color" style="background-color: var(--third-color) !important;">
                                            <div class="row">
                                                <div class="col col-12 col-md-3 py-1 px-0" style="max-height: 50px !important;"><a href="detail.php?team=1" style="/*max-height: inherit;*/"><img class="bs-icon-sm icon rounded-4" src="assets/img/samples/logo-bayern.png?h=689f785b0d375e5269cde4eff9a00b5c" style="max-height: 40px;"></a></div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="row" style="border-bottom: 1.5px solid var(--submain-background-color);">
                                                                        ...
                                                                        <div class="col align-self-center text-center p-0" style="/*border-bottom: 1.5px solid var(--third-color);*/border-left: 1.5px solid var(--third-color) !important;"><span class="text-nowrap"><img class="bs-icon-sm icon" src="assets/img/samples/logo-bayern.png?h=689f785b0d375e5269cde4eff9a00b5c" style="max-height: 1rem;">&nbsp;Bayern München</span></div>
                                                                    </div>
                                                                    <div class="row" style="border-bottom: 1.5px solid var(--submain-background-color);border-top: 1.5px solid var(--submain-background-color);">
                                                                        ...
                                                                        <div class="col align-self-center col-6 text-center" style="/*border-bottom: 1.5px solid var(--third-color);*/border-left: 1.5px solid var(--third-color) !important;"><span>32</span></div>
                                                                    </div>
                                                                    <div class="row" style="border-top: 1.5px solid var(--submain-background-color);border-bottom: 1.5px solid var(--submain-background-color);">
                                                                        ...
                                                                        <div class="col align-self-center col-6 text-center" style="/*border-bottom: 1.5px solid var(--third-color);*/border-left: 1.5px solid var(--third-color) !important;"><span>9</span></div>
                                                                    </div>
                                                                    <div class="row" style="border-top: 1.5px solid var(--submain-background-color);">
                                                                        ...
                                                                        <div class="col align-self-center col-6 text-center" style="/*border-bottom: 1.5px solid var(--third-color);*/border-left: 1.5px solid var(--third-color) !important;"><span>8</span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="carousel-item">
                                    <div class="row" style="max-height: 40rem;">
                                        <div class="col col-12 col-sm-5 ps-sm-4" style="max-height: inherit;">
                                            <div class="row">
                                                <div class="col">
                                                    <h1 class="text-center submain-color m-0">Leroy Sané</h1>
                                                </div>
                                            </div>
                                            <div class="row" style="max-height: 20rem;">
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    ...
                                                                    <div class="row" style="border-bottom: 1.5px solid var(--submain-background-color);border-top: 1.5px solid var(--submain-background-color);">
                                                                        ...
                                                                        <div class="col align-self-center col-6 text-center" style="/*border-bottom: 1.5px solid var(--third-color);*/border-left: 1.5px solid var(--third-color) !important;"><span>15</span></div>
                                                                    </div>
                                                                    <div class="row" style="border-top: 1.5px solid var(--submain-background-color);border-bottom: 1.5px solid var(--submain-background-color);">
                                                                        <div class="col col-6 text-center" style="/*border-bottom: 1.5px solid var(--third-color);*/border-right: 1.5px solid var(--third-color) !important;"><span><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-shoe">
                                                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                                        ...
                                                                        <div class="col align-self-center col-6 text-center" style="/*border-bottom: 1.5px solid var(--third-color);*/border-left: 1.5px solid var(--third-color) !important;"><span>12</span></div>
                                                                    </div>
                                                                    <div class="row" style="border-top: 1.5px solid var(--submain-background-color);">
                                                                        <div class="col col-6 text-center" style="/*border-bottom: 1.5px solid var(--third-color);*/border-right: 1.5px solid var(--third-color) !important;"><span><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-cards">
                                                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                                        ...
                                                                        <div class="col align-self-center col-6 text-center" style="/*border-bottom: 1.5px solid var(--third-color);*/border-left: 1.5px solid var(--third-color) !important;"><span>14</span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="carousel-item">
                                    <div class="row" style="max-height: 40rem;">
                                        <div class="col col-12 col-sm-5 ps-sm-4" style="max-height: inherit;">
                                            <div class="row">
                                                <div class="col">
                                                    <h1 class="text-center submain-color m-0">Jamal Musiala</h1>
                                                </div>
                                            </div>
                                            <div class="row" style="max-height: 20rem;">
                                                <div class="col text-center p-0" style="background: url(&quot;assets/img/samples/logo-bayern.png?h=689f785b0d375e5269cde4eff9a00b5c&quot;) center / contain no-repeat;filter: drop-shadow(0 10px rgba(0, 0, 0, 0.5));max-height: inherit;"><img src="assets/img/samples/players/jamal_musiala.png?h=fd6f8cfcbe3cdd4018c28ccc323fb7b4" style="max-height: inherit;filter: drop-shadow(-10px 10px rgba(0, 0, 0, 0.5));max-width: inherit;"></div>
                                            </div>
                                        </div>
                                        <div class="col align-middle align-self-center mt-3 mt-sm-0" style="max-height: inherit;">
                                            <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="row" style="border-bottom: 1.5px solid var(--submain-background-color);">
                                                                        <div class="col col-4 col-lg-5 text-center align-self-center px-2" style="/*border-bottom: 1.5px solid var(--third-color);*/border-right: 1.5px solid var(--third-color) !important;max-height: 2rem;"><span><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-shield-heart">
                                                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                                                    <path d="M12 21a12 12 0 0 1 -8.5 -15a12 12 0 0 0 8.5 -3a12 12 0 0 0 8.5 3a12.01 12.01 0 0 1 .378 5"></path>
                                                                                    <path d="M18 22l3.35 -3.284a2.143 2.143 0 0 0 .005 -3.071a2.242 2.242 0 0 0 -3.129 -.006l-.224 .22l-.223 -.22a2.242 2.242 0 0 0 -3.128 -.006a2.143 2.143 0 0 0 -.006 3.071l3.355 3.296z"></path>
                                                                                </svg>&nbsp;Equipo</span></div>
                                                                    ...
                                                                    <div class="row" style="border-bottom: 1.5px solid var(--submain-background-color);border-top: 1.5px solid var(--submain-background-color);">
                                                                        ...
                                                                        <div class="col align-self-center col-6 text-center" style="/*border-bottom: 1.5px solid var(--third-color);*/border-left: 1.5px solid var(--third-color) !important;"><span>10</span></div>
                                                                    </div>
                                                                    <div class="row" style="border-top: 1.5px solid var(--submain-background-color);border-bottom: 1.5px solid var(--submain-background-color);">
                                                                        <div class="col col-6 text-center" style="/*border-bottom: 1.5px solid var(--third-color);*/border-right: 1.5px solid var(--third-color) !important;"><span><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-shoe">
                                                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
