...
<head>
    ...
    <title>Detalle de equipo - DEPORTEX</title>
...
<body>
    ...
    <main class="page product-page main-bg-color submain-color">
                ...
                <div class="row py-3 submain-bg-color main-color rounded-5">
                    <div class="col col-12 col-md-4 col-lg-6 align-self-center">
                        <div class="row" style="height: 100%;">
                            <div class="col text-center" style="max-height: inherit;"><img class="col-10 col-md-11 col-lg-8 col-xxl-7" src="assets/img/samples/logo-bayern.png?h=689f785b0d375e5269cde4eff9a00b5c"></div>
                        </div>
                    </div>
                    <div class="col col-12 col-md-8 col-lg-6 align-self-center">
                        <div class="row">
                            <div class="col text-center text-lg-start"><span class="fs-2">Equipo</span><span class="fs-4 text-secondary smaller">&nbsp;1° en la liga</span></div>
                        </div>
                        <div class="row text-center text-lg-start">
                            <div class="col">
                                <h1 class="fs-1 fw-bolder" style="font-size: 4rem !important;color: white !important;">FC Bayern München</h1>
                            </div>
                        </div>
                        <div class="row text-center text-lg-start">
                            <div class="col"><span class="fs-3">DT: Thomas Tuchel</span></div>
                        </div>
                        <div class="row px-3">
                            <div class="col main-bg-color submain-color rounded-4">
                                <p class="fs-5">El FC Bayern München fue fundado el 27 de febrero de 1900 por once jugadores capitaneados por Franz John. Es uno de los clubes de mayor prestigio a nivel internacional y famoso por su sección de fútbol profesional, que juega en la 1° Bundesliga de Alemania.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="matches" class="custom-font mt-4 py-4 submain-bg-color">
            <div class="container py-1">
                <div class="row py-4 submain-color main-bg-color rounded-5" style="border: 5px solid var(--submain-background-color);">
                    <div class="col align-self-center text-center py-3">
                        <div class="row">
                            <div class="col">
                                <h3 class="fs-1 fw-bolder" style="font-size: 3rem !important;">Partidos</h3>
                            </div>
                        </div>
                        <div class="row px-3">
                            <div class="col main-bg-color submain-color rounded-4">
                                <p class="fs-5">Revisa el calendario de partidos para estar al tanto de los encuentros del equipo</p>
                            </div>
                        </div>
                        <div class="row justify-content-center submain-bg-color py-2 m-2 rounded-4" style="max-height: 20rem;overflow-y: auto;">
                            <div class="col py-3">
                                <nav>
                                    <ul class="nav nav-pills mb-3 custom-font matches-links" role="tablist">
                                        ...
                                        <li class="nav-item col-4" role="presentation"><button class="btn btn-primary nav-link col-12" id="pills-next-tab" type="button" data-bs-toggle="pill" role="tab" data-bs-target="#pills-next" aria-controls="pills-next" aria-selected="false">Próximos</button></li>
                                    </ul>
                                    <div id="pills-tabContent" class="tab-content custom-font rounded-3" style="background-color: #2e4000;border: 1px solid var(--main-background-color);">
                                        <div id="pills-previus" class="show active tab-pane fade" role="tabpanel" aria-labbeledby="pills-previus-tab">
                                            <div class="col px-3 py-0">
                                                <div class="row text-center rounded-3 my-2" style="border: 1px solid var(--main-background-color);background: linear-gradient(90deg, #406f10, #203103);">
                                                    <div class="col">
                                                        <div class="row mx-1">
                                                            <div class="col px-1"><span style="height: .3rem !important;">Sábado 14 / 04 / 2024&nbsp; |&nbsp; 03:00 p. m.&nbsp; |&nbsp; Polideportivo, Campo 2</span></div>
                                                        </div>
                                                        <div class="row py-2 pb-1">
                                                            <div class="col align-self-center px-0">
                                                                <div class="row mx-1 col-12">
                                                                    <div class="col align-self-center text-end col-7 px-0"><span class="text-wrap">FC Bayern München</span></div>
                                                                    <div class="col align-self-center col-5"><img class="col-12" src="assets/img/samples/logo-bayern.png?h=689f785b0d375e5269cde4eff9a00b5c" style="/*min-height: 2.5rem !important;*/max-width: 4rem;"></div>
                                                                </div>
                                                            </div>
                                                            <div class="col align-self-center col-2 px-1">
                                                                <div><span class="fs-1 goal-container">6</span><span>&nbsp;-&nbsp;</span><span class="fs-1 goal-container">0</span></div>
                                                            </div>
                                                            <div class="col align-self-center px-0">
                                                                <div class="row mx-1 col-12 px-0">
                                                                    <div class="col align-self-center col-5"><img class="col-12" src="assets/img/samples/masters-fc.png?h=b2ccd38b407a40501e86cf611779775b" style="/*min-height: 2.5rem !important;*/max-width: 4rem;"></div>
                                                                    <div class="col align-self-center text-start col-7 px-0"><span class="text-wrap">Másters FC</span></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row mx-1">
                                                            <div class="col px-1"><span class="submain-color">&nbsp;<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="1em" viewBox="0 0 24 24" width="1em" fill="currentColor">
                                                                        <g>
                                                                    ...
                                                                    </svg>&nbsp;ADÁN PÉREZ HERNÁNDEZ</span></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row text-center rounded-3 my-2 live-match-container" style="border: 1px solid var(--main-background-color);background: linear-gradient(90deg, #406f10, #203103);">
                                                    <div class="col">
                                                        <div class="row rounded-top" style="background-color: var(--submain-background-color);">
                                                            <div class="col"><span><i class="la la-trophy"></i>&nbsp;EXAGON CHAMPIONS</span></div>
                                                        </div>
                                                        ...
                                                        <div class="row py-2">
                                                            ...
                                                            <div class="col align-self-center col-3 col-sm-2 col-lg-1">
                                                                <div class="row">
                                                                    <div class="col px-xl-0"><span class="goal-container fs-1 my-auto" style="font-size: 1rem;line-height: 220%;">5</span><span class="fs-1 h-100 my-auto" style="font-size: 5rem;">-</span><span class="goal-container fs-1 my-auto" style="font-size: 1rem;line-height: 220%;">4</span></div>
                                                                </div>
                                                            </div>
                                                            <div class="col align-self-center">
                                                                <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col px-0">
                                                                <div id="accordion-2" class="accordion">
                                                                    <div class="accordion-item" style="background-color: rgba(255,255,255,0);border-color: var(--main-background-color);">
                                                                        <h2 class="accordion-header" style="background-color: rgba(255,255,255,0);border-color: var(--main-background-color);"><button class="btn accordion-button px-6 main-color py-2" type="button" style="background-color: rgba(255,255,255,0);" data-bs-toggle="collapse" data-bs-target="#accordion-1-section-2" aria-expanded="false" aria-controls="accoridion-1-section-2"><span class="align-self-center fs-5 text-center col-10">Mostrar detalles y EVENTOS DEL PARTIDO</span></button></h2>
                                                                        <div id="accordion-1-section-2" class="accordion-collapse collapse">
                                                                            <div class="accordion-body p-1">
                                                                                <div class="col">
                                                                                    <div class="row my-3">
                                                                                        <div class="col align-self-center"><span class="align-middle main-color">Finalizado</span>
                                            ...
                                            <div class="col px-3 py-0">
                                                <div class="row text-center rounded-3 my-2" style="border: 1px solid var(--main-background-color);background: linear-gradient(90deg, #406f10, #203103);">
                                                    <div class="col">
                                                        ...
                                                        <div class="row mx-1">
                                                            <div class="col px-1"><span style="height: .3rem !important;">&nbsp;<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="1em" viewBox="0 0 24 24" width="1em" fill="currentColor">
                                                                        <g>
                                                                            <rect fill="none" height="24" width="24"></rect>
                                                                        </g>
                                                                        <g>
            ...
            <div class="container py-1">
                <div class="row py-4 main-color submain-bg-color rounded-5" style="border: 5px solid var(--submain-background-color);">
                    <div class="col align-self-center text-center py-3">
                        <div class="row">
                            <div class="col">
                                <h3 class="fs-1 fw-bolder" style="font-size: 3rem !important;">JUGADORES</h3>
                            </div>
                        </div>
                        <div class="row px-3">
    ...
    <script src="assets/js/soccer.js?h=a50c4f90d94e0e697007f443c73aa1ae"></script>
</body>
