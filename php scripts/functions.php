    ...
    <div class="row text-center rounded-3 my-2 live-match-container" style="border: 1px solid var(--main-background-color);background: linear-gradient(90deg, #406f10, #203103);">
        <div class="col">
            ...
            <div class="row py-2">
                            ...
                            <div class="row">
                                <div class="col px-0" style="max-height: 5rem;">
                                    <div style="max-height: inherit;">
                                        <div class="p-0 text-lg-end pe-lg-3" style="max-height: inherit;"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/FC_Bayern_M%C3%BCnchen_logo_%282017%29.svg/2048px-FC_Bayern_M%C3%BCnchen_logo_%282017%29.svg.png" style="max-height: inherit;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col align-self-center px-0 d-none d-lg-block" style="font-size: 1.2rem;text-align: center;"><span class="fs-2">FC Bayern München</span></div>
                    </div>
                </div>
                <div class="col align-self-center col-3 col-sm-2 col-lg-1">
                    <div class="row">
                        <div class="col">
                            <span class="goal-container my-auto" style="font-size: 3rem;line-height: 250%;">3</span>
                ...
                <div class="col align-self-center">
                    <div class="row">
                        <div class="col align-self-center px-0" style="font-size: 1.2rem;text-align: center;"><span class="fs-2">Manchester City</span></div>
                        <div class="col col-12 col-lg-6 col-xl-7">
                            <div class="row">
                                <div class="col px-0" style="max-height: 5rem;">
                                    <div style="max-height: inherit;">
                                        <div class="p-0 p-0 text-lg-start ps-lg-3" style="max-height: inherit;"><img src="https://upload.wikimedia.org/wikipedia/en/thumb/e/eb/Manchester_City_FC_badge.svg/1200px-Manchester_City_FC_badge.svg.png" style="max-height: inherit;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col align-self-center px-0 d-none" style="font-size: 1.2rem;text-align: center;"><span>Manchester City</span></div>
                    </div>
                </div>
            </div>
            <div class="row">
