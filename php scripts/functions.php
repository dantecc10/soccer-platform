...
function detailed_matches_output($matches)
{
    ...
    for ($i = 0; $i < sizeof($matches[0]); $i++) {
        ...
        $temp_dom = flag_replacer($temp_dom, 'FLAG', [$matches[0][$i][$fields[0]], $matches[0][$i][$fields[1]], $matches[0][$i][$fields[2]], $matches[0][$i][$fields[3]], $matches[0][$i][$fields[4]], $matches[0][$i][$fields[5]], $matches[0][$i][$fields[6]], $matches[0][$i][$fields[7]], $matches[0][$i][$fields[8]], $matches[0][$i][$fields[9]]], [2, 3, 2, 4, 5, 7, 6, 7, 1]);
